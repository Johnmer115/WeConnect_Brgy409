...
@section('title', 'Register Resident - WeConnect Brgy 409')
@section('page-title', 'Register Resident')

@section('content')
<div class="container-fluid admin-page">
    <form method="POST" action="{{ route('admin.residents.store') }}" class="admin-form-panel">
        @csrf
        ...
        <div class="form-panel-header">
            <div>
                ...
                <p class="form-panel-subtitle">Encode the resident's basic barangay profile.</p>
            </div>
            <div class="form-panel-actions">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-floppy-disk fa-fw me-1"></i> Save Resident
                </button>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <input type="text" id="suffix" name="suffix" value="{{ old('suffix') }}" class="form-control @error('suffix') is-invalid @enderror" placeholder="Jr, Sr, III">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <input type="date" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth') }}" class="form-control @error('date_of_birth') is-invalid @enderror">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" id="religion" name="religion" value="{{ old('religion') }}" class="form-control @error('religion') is-invalid @enderror">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <select id="health_status" name="health_status" class="form-select @error('health_status') is-invalid @enderror">
                        @foreach (['Alive', 'Deceased'] as $status)
                            <option value="{{ $status }}" @selected(old('health_status', 'Alive') === $status)>{{ $status }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="date" id="date_deceased" name="date_deceased" value="{{ old('date_deceased') }}" class="form-control @error('date_deceased') is-invalid @enderror">
        ...
        <div class="form-section">
            ...
            <div class="row g-3">
                <div class="col-12 col-md-4">
                    ...
                    <input type="text" id="mobile_number" name="mobile_number" value="{{ old('mobile_number') }}" class="form-control @error('mobile_number') is-invalid @enderror">
                    @error('mobile_number') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-12 col-md-4">
                    <label for="telephone_number" class="form-label">Telephone Number</label>
                    <input type="text" id="telephone_number" name="telephone_number" value="{{ old('telephone_number') }}" class="form-control @error('telephone_number') is-invalid @enderror">
                ...
                <div class="col-12 col-md-8">
                    ...
                    <input type="text" id="home_address" name="home_address" value="{{ old('home_address') }}" class="form-control @error('home_address') is-invalid @enderror">
